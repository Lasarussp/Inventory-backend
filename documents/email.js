   ...
   <!DOCTYPE html>
     <html>
        ...
        <body>
            <div class="layout">
              <div class="content">
                <img src=${company.log} class="logo" />
                <h1 class="name">${
             ...
             <div class="footer">
               <a href="">
               <img class="footer-logo" src="https://img.freepik.com/premium-vector/invoice-hand-illustration-flat-style-transaction-document-vector-illustration-isolated-background-tax-form-sign-business-concept_157943-3017.jpg" alt="invoice" />
               </a>
             </div>

             <p style="text-align: center">Most freeable invoice at </p>
            </div>
        </body>
    </html>`;
}
